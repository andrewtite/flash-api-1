...
app.config['JWT_SECRET_KEY'] = 'supersecret' # Change this in real life lol
app.config['MAIL_SERVER']='smtp.mailtrap.io'
app.config['MAIL_PORT'] = 2525
app.config['MAIL_USERNAME'] = '5284b5512bc654'
app.config['MAIL_PASSWORD'] = '3d450d3a043989'
...
def super_simple():
    return jsonify(message="Hello from TiteNet!")
...
def add_planet():
    ...
    if test:
        ...
        return jsonify(message="Planet " + planet_name + " created!")
...
def update_planet():
    ...
    if planet:
        ...
        return jsonify(message="Planet " + planet.planet_name + " updated!")
    else:
        return jsonify(message="Planet does not exist!"), 404
